...
router.post("/buckets/:bucketName/copy-to-region", async (_req: Request, res: Response) => {
  res.status(501).json({ message: "Not implemented yet" });
});

// GET /v1/aws/:accountId/s3/buckets/:bucketName/policy
router.get("/buckets/:bucketName/policy", async (_req: Request, res: Response) => {
  res.status(501).json({ message: "Not implemented yet" });
});

// GET /v1/aws/:accountId/s3/buckets/:bucketName/sync-command
router.get("/buckets/:bucketName/sync-command", async (_req: Request, res: Response) => {
  res.status(501).json({ message: "Not implemented yet" });
});
